  ...
  return (
    <div className='pro-info-container'>
      <div className='flex flex-col justify-center items-end p-2 bg-white m-2 rounded'>
        ...
        <div onClick={() => { window.location.href = '/summary'; }} className='chart-img'>
          <img src={chart} />
          <p>گزارش</p>
        </div>
      </div>
      <div className='bg-[#fff] m-2 rounded flex flex-col justify-start items-center pt-[3vw]'>
        <div className='profile-image-container mb-[2vw]'>
          <img src={userImg} />
        </div>
        <div className='flex justify-center text-[1.5vw]'>{name}</div>
        <div className='flex justify-center text-[1.5vw] text-[#d3d5d5]'>{userName}</div>
